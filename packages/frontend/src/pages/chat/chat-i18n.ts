...
export const chatFb = {
	...
	e2eePeerNoKey: {
		en: 'Waiting for the other person to open this chat so keys can be exchanged. Text cannot be sent yet.',
		zh: '请对方先打开此私聊以完成密钥交换，在此之前无法发送文字。',
		'zh-TW': '請對方先打開此私聊以完成金鑰交換，在此之前無法傳送文字。',
		ja: '相手がこのチャットを開いて鍵交換するまで、テキストは送信できません。',
	},
	e2eeFingerprint: {
		en: 'Peer key fingerprint (compare out-of-band)',
		zh: '对方密钥指纹（可线下核对）',
		'zh-TW': '對方金鑰指紋（可線下核對）',
		ja: '相手の鍵フィンガープリント（別経路で照合可）',
	},
	e2eeKeyRotated: {
