...
export const meta = {
	...
	errors: {
		...
		aiBadRequest: {
			...
			code: 'AI_BAD_REQUEST',
			id: 'c1a2b3d4-e5f6-7890-abcd-ef1234567819',
			kind: 'client',
			httpStatusCode: 502,
		},
		aiAuthFailed: {
		...
		aiPaymentRequired: {
			...
			id: 'c1a2b3d4-e5f6-7890-abcd-ef1234567820',
			kind: 'server',
			httpStatusCode: 502,
		},
		aiForbidden: {
		...
		aiBadGateway: {
			...
			code: 'AI_BAD_GATEWAY',
			id: 'c1a2b3d4-e5f6-7890-abcd-ef1234567821',
			kind: 'server',
			httpStatusCode: 502,
		},
		aiOriginUnreachable: {
			...
			id: 'c1a2b3d4-e5f6-7890-abcd-ef1234567822',
			kind: 'server',
			httpStatusCode: 502,
		},
		aiUpstreamError: {
